   ...
   <section class="sidebar mt-10">
     <ul class="sidebar-menu" data-widget="tree">
       ...
       <?php if (is_admin()) : ?>
         ...
         <li class="treeview <?php if (isset($page_title) && $page_title == "Payment Settings " || isset($page) && $page == "Payment") {
                                echo "active";
                              } ?>">
         ...
         <li class="<?php if (isset($page_title) && $page_title == "Transactions") {
                      echo "active";
                    } ?>">
         ...
         <li class="<?php if (isset($page_title) && $page_title == "Service") {
                      echo "active";
                    } ?>">
       ...
       <?php if (is_user()) : ?>
         ...
         <li class="<?php if (isset($page_title) && $page_title == "Payment list") {
                      echo "active";
                    } ?> <?= $uval; ?>">
         ...
         <?php if (check_my_payment_status() == TRUE) : ?>
           ...
           <li class="<?php if (isset($page_title) && $page_title == "QR Settings") {
                        echo "active";
                      } ?>">
           ...
           <li class="<?php if (isset($page_title) && $page_title == "Ratings") {
                        echo "active";
                      } ?>">
           ...
           <?php if (check_feature_access('chambers') == TRUE) : ?>
             <li class="<?php if (isset($page_title) && $page_title == "Chambers") {
                          echo "active";
                        } ?>">
           ...
           <?php if (check_feature_access('online-consultation') == TRUE) : ?>
             ...
             <li class="<?php if (isset($page_title) && $page_title == "Consultation Settings") {
                          echo "active";
                        } ?>">
             ...
             <li class="<?php if (isset($page_title) && $page_title == "Consultations") {
                          echo "active";
                        } ?>">
           ...
           <?php if (check_feature_access('staffs') == TRUE) : ?>
             <li class="<?php if (isset($page_title) && $page_title == "Staff") {
                          echo "active";
                        } ?>">
           ...
           <?php if (check_feature_access('prescription') == TRUE) : ?>
             <li class="treeview <?php if (isset($page_title) && $page_title == "Prescription") {
                                    echo "active";
                                  } ?>">
       ...
       <?php if (is_staff() || is_user()) : ?>
         <?php if (check_my_payment_status() == TRUE) : ?>
           ...
           <?php if (check_feature_access('patients') == TRUE) : ?>
             <li class="<?php if (isset($page_title) && $page_title == "Patients") {
                          echo "active";
                        } ?>">
           ...
           <?php if (check_feature_access('appointments') == TRUE) : ?>
             <li class="treeview <?php if (isset($page) && $page == "Appointment") {
                                    echo "active";
                                  } ?>">
               ...
               <ul class="treeview-menu">
                 <li <?php if (isset($page_title) && $page_title == "Appointments") {
                        echo "active";
                      } ?>><a href="<?php echo base_url('admin/appointment') ?>"><i class='bx bx-right-arrow-alt'></i><?php echo trans('lists') ?></a></li>
                 <li <?php if (isset($page_title) && $page_title == "Appointment Schedule") {
                        echo "active";
                      } ?>><a href="<?php echo base_url('admin/appointment/assign') ?>"><i class='bx bx-right-arrow-alt'></i><?php echo trans('set-schedule') ?></a></li>
               </ul>
             </li>
           <?php endif; ?>


           <li class="treeview <?php if (isset($page_title) && $page_title == "Drugs") {
                                  echo "active";
                                } ?>">
             ...
             <ul class="treeview-menu">
               <li class="<?php if (isset($page_title) && $page_title == "Drugs") {
                            echo "active";
                          } ?>"><a href="<?php echo base_url('admin/drugs') ?>"><i class='bx bx-right-arrow-alt'></i><?php echo trans('drugs') ?></a></li>

               <li class="<?php if (isset($page_title) && $page_title == "Import") {
                            echo "active";
                          } ?>"><a href="<?php echo base_url('admin/file/import/drugs') ?>"><i class='bx bx-right-arrow-alt'></i>Bulk Import Drugs</a></li>
             </ul>
           </li>


           <?php if (check_feature_access('profile-page') == TRUE) : ?>
             <li class="treeview <?php if (isset($page_title) && $page_title == "Profile" || isset($page_title) && $page_title == "Educations" || isset($page_title) && $page_title == "Experience") {
                                    echo "active";
                                  } ?>">
       ...
       <!-- patient sections -->
       <?php if (is_patient()) : ?>
         <li class="<?php if (isset($page_title) && $page_title == "Patient Dashboard") {
                      echo "active";
                    } ?>">
