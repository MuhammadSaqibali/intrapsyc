                                ...
                                <tbody>
                                    ...
                                    foreach ($appointments as $amp) : ?>
                                        <tr id="row_<?php echo html_escape($amp->id); ?>" style="background: #<?php if ($amp->status == 1) {
                                            ...
                                            <td>
                                                <a target="_blank" href="<?php echo base_url('admin/h_history/chatbox/' . html_escape($amp->user_id) ."/". html_escape($amp->dr_name)); ?>" class="btn btn-light-primary btn-sm fs-12" data-placement="top" title="Chat"><i class="fa fa-comment"></i> <?php echo trans('chat') ?></a>
                                            </td>
