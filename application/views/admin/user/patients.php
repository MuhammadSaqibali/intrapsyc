                    ...
                    <table class="table table-hover <?php if(count($patientses) > 10){echo "datatable";} ?>">
                      <thead>
                        <tr>
                          ...
                          <th><?php echo trans('bio-history') ?></th>
                      ...
                      <tbody>
                        ...
                        <tr id="row_<?php echo html_escape($patients->id); ?>">
                          ...
                          <td>
                            <a target="_blank" href="<?php echo base_url('admin/patients/healthHistory/'.html_escape($patients->id));?>" class="btn btn-light-primary btn-sm fs-12" data-placement="top" title=""><i class="fa fa-eye"></i> <?php echo trans('view') ?></a>
                          </td>
